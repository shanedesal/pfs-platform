...
| Checkout | Product detail only — outline button below Add to Cart; adds selected quantity to cart then opens `/checkout` (place order still stub). Same guest/admin rules as Add to Cart |
